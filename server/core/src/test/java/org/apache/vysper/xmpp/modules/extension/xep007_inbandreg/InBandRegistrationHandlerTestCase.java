...
/**
 */
public abstract class InBandRegistrationHandlerTestCase {

	private static final String IQ_ID = "id1";

	private final AccountManagement accountManagement = Mockito.mock(AccountManagement.class);
	...
	private final SessionStateHolder sessionStateHolder = Mockito.mock(SessionStateHolder.class);
	...
	public void testGetUnauthenticated() throws XMLSemanticError {
		...
		Stanza response = handler.execute(get, serverRuntimeContext, true, sessionContext, sessionStateHolder)
				.getResponseStanza();
	...
	private void assertInnerText(final String expected, final String name, final XMLElement parent) {
		try {

...
public abstract class DbVerifyHandlerTestCase extends TestCase {
	...
	private final DbVerifyHandler handler = new DbVerifyHandler();
	...
	private void assertExecuteVerification(final String token, final String expectedType) {

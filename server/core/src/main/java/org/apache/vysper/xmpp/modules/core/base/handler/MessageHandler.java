...
public class MessageHandler extends XMPPCoreStanzaHandler {
	...
	@Override
	protected boolean verifyType(final Stanza stanza) {
		return MessageStanza.isOfType(stanza);
	}

	@Override
	protected Stanza executeCore(XMPPCoreStanza stanza, final ServerRuntimeContext serverRuntimeContext,
			final boolean isOutboundStanza, final SessionContext sessionContext) {
